                ...
                >
                    ...
                    <div class="flex items-center gap-3 px-4 py-5 border-b border-base-300">
                        ...
                        <div x-show="!collapsed" x-transition.opacity class="leading-tight overflow-hidden whitespace-nowrap">
                            ...
                            <p class="text-xs text-neutral-content/55 truncate">{{ $branding->college_name ?: 'Career Tracking System' }}</p>
                        </div>
                    </div>
                    ...
                    <nav class="sidebar-nav-scroll flex-1 min-h-0 overflow-y-auto px-2 py-4 space-y-6">
                        <div>
                            <p x-show="!collapsed" class="px-3 mb-1 text-xs font-semibold uppercase tracking-wider text-base-content/45">ภาพรวม</p>
                            <ul class="menu w-full p-0 gap-1">
                                <li>
                                    <a href="{{ route('dashboard') }}" wire:navigate title="Dashboard"
                                       class="{{ request()->routeIs('dashboard') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                        ...
                        <div>
                            <p x-show="!collapsed" class="px-3 mb-1 text-xs font-semibold uppercase tracking-wider text-base-content/45">ติดตามภาวะการทำงาน</p>
                            <ul class="menu w-full p-0 gap-1">
                                <li>
                                    <a href="{{ route('students.index') }}" wire:navigate title="Students"
                                       class="{{ request()->routeIs('students.index') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                <li>
                                    <a href="{{ route('students.recently-updated') }}" wire:navigate title="ข้อมูลนักศึกษาที่ปรับปรุงล่าสุด"
                                       class="{{ request()->routeIs('students.recently-updated') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span x-show="!collapsed" x-transition.opacity>ปรับปรุงล่าสุด</span>
                                    </a>
                                </li>
                                @auth
                                    @if (auth()->user()->hasRole(\App\Enums\UserRole::Admin, \App\Enums\UserRole::DepartmentHead))
                                        <li>
                                            <a href="{{ route('students.import') }}" wire:navigate title="นำเข้าข้อมูลนักศึกษา"
                                               class="{{ request()->routeIs('students.import') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <li>
                                            <a href="{{ route('students.trash') }}" wire:navigate title="ถังขยะ - นักศึกษา"
                                               class="{{ request()->routeIs('students.trash') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                @endauth
                                <li>
                                    <a class="pointer-events-none opacity-50 text-base-content/60" title="Career Paths">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                @auth
                                    @if (auth()->user()->hasRole(\App\Enums\UserRole::Admin, \App\Enums\UserRole::Teacher, \App\Enums\UserRole::DepartmentHead))
                                        <li>
                                            <a href="{{ route('career-statuses.create') }}" wire:navigate title="ภาวะการมีงานทำ"
                                               class="{{ request()->routeIs('career-statuses.create') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    ...
                                    @else
                                        <li>
                                            <a class="pointer-events-none opacity-50 text-base-content/60" title="ภาวะการมีงานทำ">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                                                </svg>
                        ...
                        @auth
                            @if (auth()->user()->hasRole(\App\Enums\UserRole::Admin, \App\Enums\UserRole::Executive, \App\Enums\UserRole::DepartmentHead))
                                <div>
                                    <p x-show="!collapsed" class="px-3 mb-1 text-xs font-semibold uppercase tracking-wider text-base-content/45">การจัดการ</p>
                                    <ul class="menu w-full p-0 gap-1">
                                        <li>
                                            <a href="{{ route('reports.career-status') }}" wire:navigate title="รายงานภาวะการมีงานทำ"
                                               class="{{ request()->routeIs('reports.career-status') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" />
                                                </svg>
                                                <span x-show="!collapsed" x-transition.opacity>รายงานภาวะการมีงานทำ</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('reports.self-report-usage') }}" wire:navigate title="สถิติการใช้งานหน้าแจ้งข้อมูล"
                                               class="{{ request()->routeIs('reports.self-report-usage') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
                                                </svg>
                                                <span x-show="!collapsed" x-transition.opacity>สถิติการใช้งาน</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('reports.export') }}" wire:navigate title="ส่งออกรายงาน"
                                               class="{{ request()->routeIs('reports.export') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            ...
                            @if (auth()->user()->hasRole(\App\Enums\UserRole::Admin, \App\Enums\UserRole::Teacher, \App\Enums\UserRole::DepartmentHead))
                                <div>
                                    <p x-show="!collapsed" class="px-3 mb-1 text-xs font-semibold uppercase tracking-wider text-base-content/45">แจ้งเตือน</p>
                                    <ul class="menu w-full p-0 gap-1">
                                        <li>
                                            <a href="{{ route('notifications.reminders') }}" wire:navigate title="แจ้งเตือนนักศึกษา"
                                               class="{{ request()->routeIs('notifications.reminders') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        @if (auth()->user()->isAdmin())
                                            <li>
                                                <a href="{{ route('notifications.logs') }}" wire:navigate title="ประวัติการแจ้งเตือน"
                                                   class="{{ request()->routeIs('notifications.logs') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            ...
                            @if (auth()->user()->isAdmin())
                                <div>
                                    <p x-show="!collapsed" class="px-3 mb-1 text-xs font-semibold uppercase tracking-wider text-base-content/45">ตั้งค่าระบบ</p>
                                    <ul class="menu w-full p-0 gap-1">
                                        <li>
                                            <a href="{{ route('settings.academic-years') }}" wire:navigate title="ปีการศึกษา"
                                               class="{{ request()->routeIs('settings.academic-years') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <li>
                                            <a href="{{ route('settings.system') }}" wire:navigate title="ข้อมูลระบบ"
                                               class="{{ request()->routeIs('settings.system') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <li>
                                            <a href="{{ route('settings.users') }}" wire:navigate title="จัดการผู้ใช้งาน"
                                               class="{{ request()->routeIs('settings.users') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <li>
                                            <a href="{{ route('settings.backup') }}" wire:navigate title="สำรอง/กู้คืนข้อมูล"
                                               class="{{ request()->routeIs('settings.backup') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <li>
                                            <a href="{{ route('audit-logs.index') }}" wire:navigate title="บันทึกการใช้งานระบบ"
                                               class="{{ request()->routeIs('audit-logs.index') ? 'active bg-primary text-primary-content' : 'text-base-content/60 hover:bg-base-200' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <div class="hidden lg:block border-t border-base-300 p-2">
                        <button
                            ...
                            class="btn btn-ghost btn-sm w-full text-base-content/60 hover:bg-base-200"
